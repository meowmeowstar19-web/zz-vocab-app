...
export default function App() {
  ...
  return (
    <div className="w-screen flex items-center justify-center font-cute overflow-hidden" style={{ height: vpH, backgroundColor: '#2b2a26', paddingTop: 'env(safe-area-inset-top)' }}>
