...
export default function App() {
  ...
  return (
    <div className="w-screen flex items-center justify-center font-cute overflow-hidden" style={{ height: vpH, backgroundColor: '#f5e2db', paddingTop: 'env(safe-area-inset-top)' }}>
