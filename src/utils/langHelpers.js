...
export const UI_TEXT = {
  zh: {
    ...
    allWords: '所有单词',
    // Word list
    learning: '学习中', review: '去复习', backToTop: '回到顶部',
    timeOrder: '时间顺序', randomOrder: '随机顺序', reverseRandom: '反向随机',
    mastered: '已斩单词',
    vocabIllustrated: '词汇图鉴', wordsTab: '单词', phrasesTab: '短语',
    searchPlaceholder: '搜索', noSearchResult: '没有找到相关的内容',
    searchTip: '换个词试试，或者只输入其中几个字',
    noMastered: '还没有已斩单词', noLearned: '还没有学过的单词',
    noMasteredPhrases: '还没有已斩短语', noLearnedPhrases: '还没有学过的短语',
    masteredTip: '点击「斩」来斩杀单词吧！', learnedTip: '快开始学习吧',
    close: '关闭',
    // Settings
    ...
    emailTypoSuggest: '是不是想输入 {s} ？',
    emailOtpHint: '我们会发送一个 6 位验证码到你的邮箱。',
    sendCodeBtn: '发送验证码',
    ...
    feedbackRow: '意见反馈',
    feedbackTitle: '意见反馈',
    feedbackPlaceholder: '欢迎告诉我们你的想问，问题，建议，和bug！谢谢⁄(⁄ ⁄•⁄ω⁄•⁄ ⁄)⁄',
    feedbackEmpty: '请先输入反馈内容',
    feedbackLoginRequired: '登录后才能发送意见反馈哦~',
    languageSwitchLocked: '切换次数已用完，暂时不支持继续切换哦~',
    languageSwitchConfirm: '切换后只剩 {n} 次切换机会，确认要切换吗？',
    feedbackSent: '反馈已发送，谢谢你！',
    feedbackSendFailed: '发送失败，请稍后再试',
    feedbackImagesTooMany: '最多只能选 10 张图哦~',
    feedbackImageUploadFailed: '图片上传失败，请重试',
    feedbackAddImage: '添加图片',
    send: '发送',
    // Follow us
    followUsRow: '求关注',
    // Profile
  ...
  en: {
    ...
    allWords: 'All words',
    learning: 'Learning', review: 'Review', backToTop: 'Back to top',
    timeOrder: 'By Time', randomOrder: 'Random', reverseRandom: 'Reverse',
    mastered: 'Mastered',
    vocabIllustrated: 'Gallery', wordsTab: 'Words', phrasesTab: 'Phrases',
    searchPlaceholder: 'Search', noSearchResult: 'Nothing matched',
    searchTip: 'Try another word, or just part of one',
    noMastered: 'No mastered words yet', noLearned: 'No learned words yet',
    noMasteredPhrases: 'No mastered phrases yet', noLearnedPhrases: 'No learned phrases yet',
    ...
    emailTypoSuggest: 'Did you mean {s} ?',
    emailOtpHint: "We'll send a 6-digit code to your email.",
    ...
    languageSwitchLocked: 'You\'ve used up your language switches~',
    languageSwitchConfirm: 'You\'ll have {n} switch(es) left after this. Continue?',
    feedbackSent: 'Feedback sent — thank you!',
    feedbackSendFailed: 'Send failed, please try again',
    feedbackImagesTooMany: 'You can attach up to 10 images.',
    feedbackImageUploadFailed: 'Image upload failed, please retry',
    feedbackAddImage: 'Add image',
    send: 'Send',
    // Follow us
    followUsRow: 'Follow us',
    // Profile
  ...
  ja: {
    ...
    translating: '翻訳中…',
    allWords: '全ての単語',
    learning: '学習中の単語', review: '復習する', backToTop: 'トップへ戻る',
    timeOrder: '時間順', randomOrder: 'ランダム', reverseRandom: '逆ランダム',
    mastered: '習得済み',
    vocabIllustrated: '図鑑', wordsTab: '単語', phrasesTab: 'フレーズ',
    searchPlaceholder: '検索', noSearchResult: '見つかりませんでした',
    searchTip: '別の言葉や、一部だけでも試してみてください',
    noMastered: '習得済みの単語はまだありません', noLearned: 'まだ学習した単語はありません',
    noMasteredPhrases: '習得済みのフレーズはまだありません', noLearnedPhrases: 'まだ学習したフレーズはありません',
    ...
    emailTypoSuggest: 'もしかして {s} ですか？',
    emailOtpHint: 'メールに 6 桁の確認コードをお送りします。',
    sendCodeBtn: 'コードを送信',
    sendCodeFailed: 'コードの送信に失敗しました。後ほど再度お試しください',
    ...
    languageSwitchLocked: '切り替え回数を使い切りました。これ以上は切り替えできません~',
    languageSwitchConfirm: '切り替え後、残り {n} 回となります。切り替えますか？',
    feedbackSent: '送信しました。ありがとうございます！',
    feedbackSendFailed: '送信に失敗しました。あとでもう一度お試しください',
    feedbackImagesTooMany: '画像は最大 10 枚まで添付できます。',
    feedbackImageUploadFailed: '画像のアップロードに失敗しました。再試行してください',
    feedbackAddImage: '画像を追加',
    send: '送信',
    // Follow us
    followUsRow: 'フォローしてね',
    // Profile
