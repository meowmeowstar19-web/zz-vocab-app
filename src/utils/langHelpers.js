...
export const UI_TEXT = {
  zh: {
    ...
    installIosOtherTip: '由于苹果限制，iPhone 上只有 Safari 才能添加到主屏幕。\n\n请复制本页网址，在 Safari 中打开，然后点击底部「分享」→「添加到主屏幕」。',
  ...
  en: {
    ...
    installIosOtherTip: 'Apple only allows Safari to add web apps to the home screen on iPhone.\n\nCopy this page\'s URL, open it in Safari, then tap Share → "Add to Home Screen".',
  ...
  ja: {
    ...
    installIosOtherTip: 'Apple の制限により、iPhone では Safari のみホーム画面に追加できます。\n\nこのページの URL をコピーして Safari で開き、下部の「共有」→「ホーム画面に追加」をタップしてください。',
