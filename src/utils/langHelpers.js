...
export const UI_TEXT = {
  ...
  en: {
    ...
    installIosTip: 'Tap the Share button at the bottom of Safari, choose "View More", scroll down, then select "Add to Home Screen".',
    installIosChromeTip: 'Tap the "⋯" button at the bottom, choose "Share", then "View More", scroll down, and select "Add to Home Screen".',
  ...
  ja: {
    ...
    installIosTip: 'Safari 下部の「共有」ボタンをタップし、「もっと見る」を選んで下にスクロールし、「ホーム画面に追加」を選択してください。',
    installIosChromeTip: '下部の「⋯」ボタンをタップし、「共有」を選び、「もっと見る」をタップして下にスクロールし、「ホーム画面に追加」を選択してください。',
