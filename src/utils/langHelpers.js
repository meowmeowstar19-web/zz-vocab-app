...
export const UI_TEXT = {
  zh: {
    ...
    installIosTip: '点击 Safari 底部的分享按钮，再点击弹窗右上角的展开按钮（向上的小箭头），下滑找到「添加到主屏幕」即可。',
    installIosChromeTip: '点击 Chrome 右上角的分享按钮，再点击弹窗右上角的展开按钮（向上的小箭头），下滑找到「添加到主屏幕」即可。',
  ...
  en: {
    ...
    installIosTip: 'Tap the Share button at the bottom of Safari, then tap the expand button (small upward chevron) at the top-right of the popup, and scroll down to find "Add to Home Screen".',
    installIosChromeTip: 'Tap the Share button at the top-right of Chrome, then tap the expand button (small upward chevron) at the top-right of the popup, and scroll down to find "Add to Home Screen".',
  ...
  ja: {
    ...
    installIosTip: 'Safari 下部の共有ボタンをタップし、表示されたポップアップ右上の展開ボタン（上向きの矢印）をタップして、下にスクロールして「ホーム画面に追加」を選んでください。',
    installIosChromeTip: 'Chrome 右上の共有ボタンをタップし、表示されたポップアップ右上の展開ボタン（上向きの矢印）をタップして、下にスクロールして「ホーム画面に追加」を選んでください。',
