...
export const UI_TEXT = {
  zh: {
    ...
    installIosChromeTip: '请点击右上角「分享」按钮，然后选择「添加到主屏幕」。',
  ...
  en: {
    ...
    installIosChromeTip: 'Tap the Share button in the top-right, then choose "Add to Home Screen".',
  ...
  ja: {
    ...
    installIosChromeTip: '右上の「共有」ボタンをタップし、「ホーム画面に追加」を選択してください。',
